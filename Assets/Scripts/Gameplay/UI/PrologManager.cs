...
public class PrologManager : MonoBehaviour
{
    ...
    Sequence prologPagesSequence;
    Sequence splashLogosSeqeuence;

    public GameObject skipSceneButton;
    ...
    void Start()
    {
        ...
        splashLogosSeqeuence = DOTween.Sequence();
        ...
        splashLogosSeqeuence
            ...
            .OnComplete(() =>
            {
                prologPagesSequence = DOTween.Sequence();
    ...
    {
        prologPagesSequence.Pause();
        splashLogosSeqeuence.Pause();

        Sequence sceneSkipSequence = DOTween.Sequence();
        sceneSkipSequence
            .Append(blackScreen.DOFade(1f, 0.5f))
            .OnComplete(() =>
            {
                DOTween.KillAll();
                CurrentLevelStatic.lastBuildIndex = SceneManager.GetActiveScene().buildIndex;
